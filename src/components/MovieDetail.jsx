...
export default function MovieDetail() {
  ...
  //영화상세정보
  return (
    <div className="min-h-screen bg-black text-white p-4 py-{30px}">
      ...
      <div className="container mx-auto py-8">
        <div className="flex flex-col gap-8 md:flex-row">
          ...
          <h1 className="text-4xl fomt-bold mb-4">{movie.title}</h1>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <h3 className="text-yellow-500">Vote Average</h3>
